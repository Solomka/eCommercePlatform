...
<table border="0" width="90%">
    <form:form action="check" method="post" commandName="card">
    <tr>
        <td align="left" width="20%">Number:</td>
        <td align="left" width="40%"><form:input path="number" size="30"/></td>
        <td align="left"><form:errors path="number" cssClass="error"/></td>
    </tr>
    <tr>
        <td>cvv2:</td>
