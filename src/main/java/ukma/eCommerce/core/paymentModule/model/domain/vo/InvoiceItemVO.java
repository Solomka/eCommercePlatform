...
public final class InvoiceItemVO {
    ...
    public static class Builder implements IBuilder<InvoiceItemVO> {
        ...
        public Builder(@NotNull InvoiceItemVO invoiceItem) {

            if (invoiceItem == null)
                throw new NullPointerException("invoiceItem must not bu null");
    ...
    private InvoiceItemVO(@NotNull Builder builder) {
        if (builder == null)
