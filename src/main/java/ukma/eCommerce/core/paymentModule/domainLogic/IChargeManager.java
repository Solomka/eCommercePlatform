...
public interface IChargeManager {
     ...
     */
    @NotNull
    Observable<ChargeSaveDTO> conductCharge(@NotNull InvoicePMDTO invoice);
     ...
     */
    @NotNull
    Observable<ChargeSaveDTO> conductCharge(@NotNull InvoicePMDTO invoice, @NotNull CreditCard creditCard);
