...
public final class Validators {
	 ...
	 * 
	 * @param <T>
	 *            validate target class which implements
	 *            {@linkplain IValidateable}
	 * @param c
	 *            class for which validator should be returned
	 */
	@SuppressWarnings("unchecked")
	public static <T extends IValidateable> IValidator<T> forClass(@NotNull Class<T> c) {

		final IValidator<T> validator = (IValidator<T>) bindings.get(Objects.requireNonNull(c, "class == null"));
